...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('otp-generate', 'LoginController@otp_generate')->name('otp-generate');
        Route::post('login-otp', 'LoginController@login_otp')->name('login-otp');
    ...
    Route::group([], function () {
        ...
        Route::post('choose-shipping-address', [SystemController::class,'choose_shipping_address'])->name('choose-shipping-address');
