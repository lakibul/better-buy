...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('stock-export-excel', 'ProductController@export_excel_stock')->name('stock-export-excel');
            ...
            Route::post('clone/{id}', 'ProductController@clone')->name('clone');
            ...
            Route::get('stock-bulk-import', 'ProductController@stock_bulk_import_index')->name('stock-bulk-import');
            Route::post('stock-bulk-import', 'ProductController@stock_bulk_import_data');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        //log
        Route::group(['prefix' => 'admin-log', 'as' => 'admin-log.'], function () {
            Route::get('admin-activity', 'LogController@admin_activity')->name('admin-activity');
            Route::get('seller-activity', 'LogController@seller_activity')->name('seller-activity');
            Route::get('merchant-activity', 'LogController@merchant_activity')->name('merchant-activity');
        });
//        Route::group(['prefix' => 'seller-log', 'as' => 'seller-log.','middleware'=>['module:user_section']], function () {
//            Route::get('seller-activity', 'LogController@seller_activity')->name('seller-activity');
//        });
    });
});
