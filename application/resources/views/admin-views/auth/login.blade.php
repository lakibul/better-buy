...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        <label class="badge badge-soft-success d-none float-right __inline-2">{{\App\CPU\translate('Software version')}} : {{ env('SOFTWARE_VERSION') }}</label>
        @php($e_commerce_logo=\App\Model\BusinessSetting::where(['type'=>'company_web_logo'])->first()->value)
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2" height="60" src="{{asset("application/storage/app/public/company/".$e_commerce_logo)}}" alt="Logo"
                 onerror="this.src='{{asset('assets/back-end/img/logo.png')}}'">
        </a>
