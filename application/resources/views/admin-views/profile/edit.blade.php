                ...
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <div class="profile-cover">
                            @php($shop_banners = $shop_banner ? asset('application/storage/app/public/shop/'.$shop_banner) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="{{asset('application/storage/app/public/admin')}}/{{$data->image}}"
                                 alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
