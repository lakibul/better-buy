    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                @if($type == 'in_house')
                    {{\App\CPU\translate('Admin_Product_List')}}
                @elseif($type == 'seller')
                    {{\App\CPU\translate('Admin_Product_List')}}
                @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a class="btn btn-outline-info btn-sm square-btn"   title="{{\App\CPU\translate('Clone')}}" href="javascript:"
                                               onclick="form_alert('product-clone-{{$p['id']}}','Want to clone this item ?')">
                                        ...
                                        <form action="{{route('admin.product.clone',[$p['id']])}}"
                                              method="post" id="product-clone-{{$p['id']}}">
                                            @csrf @method('post')
                                        </form>
                                    </td>
                                </tr>
