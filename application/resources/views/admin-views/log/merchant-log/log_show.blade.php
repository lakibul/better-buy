...
@section('title', \App\CPU\translate('Merchant log'))
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="flex-start">
                    <h5 class="card-header-title">{{\App\CPU\translate('merchant Logs')}}</h5>
                    <h5 class="card-header-title text-primary mx-1"> </h5>
                </div>
                <div>
