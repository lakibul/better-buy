        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="mt-1">
                ...
                <button type="button"
                    ...
                    <button type="button" class="js-navbar-vertical-aside-toggle-invoker sidebar-toggle-btn close d-none d-xl-block">
                        <i class="fa fa-arrow-left navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                           data-placement="right" title="" data-original-title="Collapse"></i>
                        <i class="fa fa-arrow-right navbar-vertical-aside-toggle-full-align"
            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="">
                    ...
                    <img class="navbar-brand-logo-mini"
                         onerror="this.src='{{asset('assets/front-end/img/logo.png')}}'"
                         src="{{asset("application/storage/app/public/company/$e_commerce_logo")}}"
                         alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
                            ...
                            <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                                   href="{{route('admin.orders.list',['status'=>'pending'])}}">
                                    ...
                                    <span
                                        class="btn-status btn-sm-status btn-status-warning">{{\App\Model\Order::where('order_status','pending')->count()}}</span>
                                </a>
                            </div>
                            <!-- End Notification -->
                        </li>
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar border avatar-circle">
                                    <img class="avatar-img"
                                         ...
                                         src="{{asset('application/storage/app/public/admin')}}/{{auth('admin')->user()->image}}"
