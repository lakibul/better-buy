        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <img class="navbar-brand-logo for-web-logo max-h-60 mx-auto"
                         onerror="this.src='{{asset('assets/front-end/img/logo.png')}}'"
                         src="{{asset("application/storage/app/public/company/$e_commerce_logo")}}" alt="Logo">
                        <img onerror="this.src='{{asset('assets/back-end/img/logo-mini.png')}}'"
                ...
                <!-- Content -->
                <div class="navbar-vertical-content navbar-vertical-content-custom">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('order_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu d-none {{Request::is('admin/refund-section/refund/*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || (Request::is('admin/product/add-new')) || (Request::is('admin/product/view/*')) || (Request::is('admin/product/barcode/*')) ||  Request::is('admin/product/stock-bulk-import'))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('InHouse Products')}}">
                                    <i class="tio-shop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{\App\CPU\translate('Admin Products')}}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/product/stock-bulk-import')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.product.stock-bulk-import')}}"
                                           title="{{\App\CPU\translate('stock_bulk_import')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('stock_bulk_import')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/product/list/seller*')||Request::is('admin/product/updated-product-list')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   ...
                                   title="{{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Products')}}">
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Merchant')}} {{\App\CPU\translate('Products')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="nav-item d-none {{(Request::is('admin/support-ticket*') || Request::is('admin/contact*'))?'scroll-here':''}}">
                            <small class="nav-subtitle"
                                   title="">{{\App\CPU\translate('help_&_support_section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <li class="d-none navbar-vertical-aside-has-menu {{Request::is('admin/contact*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="d-none navbar-vertical-aside-has-menu {{(Request::is('admin/report/earning') || Request::is('admin/report/inhoue-product-sale') || Request::is('admin/report/seller-product-sale') || Request::is('admin/report/earning') || Request::is('admin/transaction/list') || Request::is('admin/refund-section/refund-list')) ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                        ...
                        <li class="d-none navbar-vertical-aside-has-menu {{ (Request::is('admin/stock/product-in-wishlist')) ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                        ...
                        <li class="d-none navbar-vertical-aside-has-menu {{Request::is('admin/report/order')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="d-none navbar-vertical-aside-has-menu {{Request::is('admin/stock/product-stock')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="d-none navbar-vertical-aside-has-menu {{(Request::is('admin/employee*') || Request::is('admin/custom-role*'))?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('log_management'))

                            <li class="nav-item {{(Request::is('admin/admin-log*') || Request::is('admin/admin-log/admin-activity')||Request::is('admin/admin-log/seller-activity'))?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{\App\CPU\translate('log_details')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/admin-log*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                >
                                    <i class="tio-group-senior nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('log')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/admin-log*')?'block':'none'}}">
                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/admin-log/admin-activity')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.admin-log.admin-activity')}}"
                                           title="{{\App\CPU\translate('admin activity')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('admin activity')}}</span>
                                        </a>
                                    </li>

                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/admin-log/seller-activity')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.admin-log.seller-activity')}}"
                                           title="{{\App\CPU\translate('seller activity')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('seller activity')}}</span>
                                        </a>
                                    </li>

{{--                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/admin-log/merchant-activity')?'active':''}}">--}}
{{--                                        <a class="nav-link " href="{{route('admin.admin-log.merchant-activity')}}"--}}
{{--                                           title="{{\App\CPU\translate('merchant activity')}}">--}}
{{--                                            <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                            <span class="text-truncate">{{\App\CPU\translate('merchant activity')}}</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
                                </ul>
                            </li>
                        @endif
                        {{--                        @if(\App\CPU\Helpers::module_permission_check('user_section'))--}}
                        {{--                            <li class="navbar-vertical-aside-has-menu {{Request::is('seller/seller-log*')?'active':''}}">--}}
                        {{--                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"--}}
                        {{--                                >--}}
                        {{--                                    <i class="tio-group-senior nav-icon"></i>--}}
                        {{--                                    <span--}}
                        ...
                        {{--                                </a>--}}
                        {{--                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/admin-log*')?'block':'none'}}">--}}
                        {{--                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/seller-log/seller-activity')?'active':''}}">--}}
                        {{--                                        <a class="nav-link " href="{{route('admin.seller-log.seller-activity')}}"--}}
                        {{--                                           title="{{\App\CPU\translate('seller activity')}}">--}}
                        {{--                                            <span class="tio-circle nav-indicator-icon"></span>--}}
                        {{--                                            <span class="text-truncate">{{\App\CPU\translate('seller activity')}}</span>--}}
                        {{--                                        </a>--}}
