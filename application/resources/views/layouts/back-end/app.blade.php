...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{asset('assets/back-end')}}/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="{{asset('assets/back-end')}}/css/style.css">
     ...
     <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('assets/back-end')}}/css/custon-style.css">
