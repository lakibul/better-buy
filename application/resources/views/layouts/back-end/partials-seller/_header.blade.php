        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3 d-none d-xl-block">
                    <i class="fa fa-arrow-left navbar-vertical-aside-toggle-short-align" data-toggle="tooltip" data-placement="right" title="" data-original-title="Collapse"></i>
                    <i class="fa fa-arrow-right navbar-vertical-aside-toggle-full-align" data-template="<div class=&quot;tooltip d-none d-sm-block&quot; role=&quot;tooltip&quot;><div class=&quot;arrow&quot;></div><div class=&quot;tooltip-inner&quot;></div></div>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Expand"></i>
                </button>
                <!-- Navbar Vertical Toggle -->
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3 d-xl-none">
                    <i class="fa fa-bars navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                       data-placement="right" title="Collapse"></i>
                    <i class="fa fa-bars navbar-vertical-aside-toggle-full-align"
                ...
                <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="">
                    @if (isset($shop))
                        <img class="navbar-brand-logo"
                             ...
                             src="{{asset("application/storage/app/public/shop/$shop->image")}}" alt="Logo" height="40">
                        <img class="navbar-brand-logo-mini"
                             onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                             src="{{asset("application/storage/app/public/shop/$shop->image")}}"
                             alt="Logo" height="40">
                            ...
                            <a class="js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow"
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="d-none d-md-block media-body text-right">
                                    ...
                                    <span
                                        class="fz-12">{{ @$shop->name ? \Illuminate\Support\Str::limit($shop->name, 20):'' }}</span>
                                </div>
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                                         src="{{asset('application/storage/app/public/seller/')}}/{{auth('seller')->user()->image}}"
