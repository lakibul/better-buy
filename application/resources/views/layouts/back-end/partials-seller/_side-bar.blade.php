                    ...
                    <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="Front">
                        @if (isset($shop))
                            <img onerror="this.src='{{asset('assets/back-end/img/900x400/img1.jpg')}}'"
                                ...
                                src="{{asset("application/storage/app/public/shop/$shop->image")}}" alt="Logo">
                        @else
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/product*'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('seller/product/stock-bulk-import')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.stock-bulk-import')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('stock-bulk-import')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
