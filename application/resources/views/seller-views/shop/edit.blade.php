                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="text-center">
                                    ...
                                    src="{{asset('application/storage/app/public/shop/'.$shop->image)}}" alt="Product thumbnail"/>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4 mt-2">
                                ...
                                <div class="text-center">
                                    <img class="upload-img-view" id="viewerBanner"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('application/storage/app/public/shop/banner/'.$shop->banner)}}" alt="Product thumbnail"/>
                                </div>
                            </div>
                        </div>
