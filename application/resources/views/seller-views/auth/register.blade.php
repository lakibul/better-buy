...
<div class="container py-5 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    <form class="merchant-reg" action="{{route('shop.apply')}}" id="form-id" method="post" enctype="multipart/form-data">
        <div class="card __card mb-3 py-4">
            <div class="card-header">
                <h4 class="card-title mb-4 text-center" style="font-size:30px!important;font-weight: 600!important;">
                    {{\App\CPU\translate('Merchant')}} {{\App\CPU\translate('Signup')}}
                </h4>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6 my-2">
                        ...
                        <select name="merchant-type" id="" class="form-control">
                    ...
                    <div class="col-sm-6 my-2">
                        ...
                        <input type="text" class="form-control form-control-user" id="exampleFirstName" name="f_name" value="{{old('f_name')}}" placeholder="{{\App\CPU\translate('full_name')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Registration Number : </label>
                        <input type="text" class="form-control form-control-user" id="exampleLastName" name="l_name" value="{{old('l_name')}}" placeholder="{{\App\CPU\translate('registration_number')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Phone Number : </label>
                        <small class="text-danger">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for_Nepal_977')}} )</small>
                    ...
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Web URL :</label>
                        <input type="url" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('WEB_URL')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant PAN No.  : </label>
                        <input type="number" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('PAN NO.')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Contract Date  : </label>
                        <input type="date" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('v')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant URL  :</label>
                        <input type="url" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('Merchant_URL')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                    ...
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Province  : </label>
                        <select name="merchant-type" id="" class="form-control">
                    ...
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant District  : </label>
                        <select name="merchant-type" id="" class="form-control">
                            <option value="">Bangladesh</option>
                            <option value="">USA</option>
                            <option value="">India</option>
                    ...
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Municipality  : </label>
                        <select name="merchant-type" id="" class="form-control">
                            <option value="">Bangladesh</option>
                            <option value="">USA</option>
                            <option value="">India</option>
                    ...
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Ward No.  : </label>
                        <input type="text" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('Ward No.')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Street : </label>
                        <input type="text" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('Street')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Bank Account Name : </label>
                        <input type="text" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('Bank_Account_Name')}}" required>
                    </div>
                    <div class="col-sm-6 my-2">
                        <label for="">Merchant Bank Account Number : </label>
                        <input type="text" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="{{\App\CPU\translate('Bank_Account_Number')}}" required>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <button type="submit" class="btn btn--primary btn-user btn-block" id="apply" disabled>{{\App\CPU\translate('Apply')}}</button>
