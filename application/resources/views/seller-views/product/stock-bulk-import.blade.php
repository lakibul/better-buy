    ...
    <div class="content container-fluid">
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                ...
                <div class="col-12 my-2">
                    <div class="card card-body">
                        ...
                        <table class="table table-borderless table-striped">
                            <thead>
                            <tr>
                                <th>{{\App\CPU\translate('Sku code')}}</th>
            ...
            <div class="col-md-12 mt-2">
                <form class="product-form" action="{{route('seller.product.stock-bulk-import')}}" method="POST"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            <h4 class="mb-0">{{\App\CPU\translate("download example format")}}</h4>
                            ...
                            <a class="btn-link text-capitalize fz-16 font-weight-medium" href="{{route('seller.product.stock-export-excel')}}">{{\App\CPU\translate('download_here')}}</a>
