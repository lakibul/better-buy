            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-sm-4 pt-2">
                        ...
                        <a href="{{asset("application/storage/app/public/product/digital-product/$product->digital_file_ready")}}" class="btn btn--primary px-4 mt-4">{{\App\CPU\translate('download')}}</a>
                        @endif
                    </div>
