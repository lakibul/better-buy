                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3" id="digital_file_ready_show">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="h-100 mt-5">
                                                    <a href="{{asset("application/storage/app/public/product/digital-product/$product->digital_file_ready")}}" target="_blank">{{ $product->digital_file_ready }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img class="w-100" height="auto"
                                                             ...
                                                             src="{{asset("application/storage/app/public/product/meta")}}/{{$product['meta_image']}}"
                                                             alt="Meta image">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img class="w-100" height="auto"
                                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                         src="{{asset("application/storage/app/public/product/thumbnail")}}/{{$product['thumbnail']}}"
                                                         alt="Product image">
                                                </div>
                                            </div>
                                        </div>
...
@push('script')
    ...
    {{--ck editor--}}
    <script src="{{ asset('/') }}/application/vendor/ckeditor/ckeditor/ckeditor.js"></script>
    <script src="{{ asset('/') }}/application/vendor/ckeditor/ckeditor/adapters/jquery.js"></script>
    <script>
        $('.textarea').ckeditor({
