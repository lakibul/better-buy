...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{asset('application/storage/app/public/shop')}}/{{$shop->image}}"/>
        <meta property="og:title" content="{{ $shop->name}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="og:image" content="{{asset('application/storage/app/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="og:title" content="{{ $shop['name']}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
    ...
    @if($shop['id'] != 0)
        <meta property="twitter:card" content="{{asset('application/storage/app/public/shop')}}/{{$shop->image}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="twitter:card"
              content="{{asset('application/storage/app/public/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
                ...
                <div class="bg-white">
                    @if($shop['id'] != 0)
                        <img class="__shop-page-banner"
                             src="{{asset('application/storage/app/public/shop/banner')}}/{{$shop->banner}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @else
                        @php($banner=\App\CPU\Helpers::get_business_settings('shop_banner'))
                        <img class="__shop-page-banner"
                             src="{{asset("application/storage/app/public/shop")}}/{{$banner??""}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @endif
                </div>
