                ...
                <div class="checkout_details">
                    ...
                    <div class="row g-3">
                                ...
                                <div class="card cursor-pointer">
                                    <div class="card-body __h-100px">
                                        <form action="{{route('checkout-complete')}}" method="get"
                                              class="needs-validation" id="cash_on_delivery">
                        ...
                        @if ($digital_payment['status']==1)
                            ...
                            @endif
                            @php($config=\App\CPU\Helpers::get_business_settings('esewa'))
                            @if($config['status'])
                                <div class="col-sm-6">
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">

                                            <form class="needs-validation" method="POST" id="payment-form-esewa"
                                                  action="{{route('pay-esewa')}}">
                                                @csrf
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="150"
                                                         src="{{asset('assets/front-end/img/esewa.png')}}"
                                                         alt="e-sewa"/>
                                                </button>
                                            </form>
                                        </div>
                            ...
                            @endif
                            @php($config=\App\CPU\Helpers::get_business_settings('khalti'))
                            @if($config['status'])
                                <div class="col-sm-6">
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">

                                            <form class="needs-validation" method="POST" id="payment-form-khalti"
                                                  action="#">
                                                @csrf
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="150"
                                                         src="{{asset('assets/front-end/img/khalti.png')}}"
                                                         alt="khalti"/>
                                                </button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-body __h-100px">
                                            <form action="{!!route('payment-razor')!!}" method="POST">
                                                ...
                                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                        ...
                                                        data-description=""
                                                        data-image="{{asset('application/storage/app/public/company/'.\App\Model\BusinessSetting::where(['type'=>'company_web_logo'])->first()->value)}}"
                                            ...
                                            <form method="POST" action="{{ route('paystack-pay') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-md-offset-2">
                                                        ...
                                                        <p>
                                                            <button class="paystack-payment-button"
                                                                    style="display: none"
                                                                    type="submit"
...
@push('script')
    ...
    <script>
        ...
        window.onload = function () {
            ...
            document.getElementById("payment-form-esewa").submit();
            @elseif($billing_method == 'KHALTI')
                location.href = '{{route('payment-form',['amount'=> $amount])}}';
            @elseif($billing_method =='COD')
