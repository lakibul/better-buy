        ...
        <div class="container pb-5 mb-2 rtl">
            ...
            <!-- Content  -->
                <section class="col-lg-9 col-md-9">
                    <h2 class="profile-page-heading">Address Book</h2>
                    <p class="profile-page-head-txt mb-2">This section contains your address information</p>
                    <!-- Addresses list-->
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="user-profile-head">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <img class="mr-3 position-relative" style="width: 20px; height: 20px; top: -3px;" src="{{asset('assets/front-end/img/users-icon.png')}}"
                                             alt="">
                                        <h3 style=" font-weight: 600;margin-top: 0px;margin-bottom: 7px !important;font-size: 17px;color: #030303;">{{\App\CPU\translate('Default_Address')}} </h3>
                                    </div>
                                    <div class="profile-edit">
                                        <button ype="submit" class="profile-edit-btn" data-toggle="modal"
                            ...
                            <div class="row g-3">
                                @foreach($shippingAddresses as $shippingAddress)
                                    <section class="col-lg-6 col-md-6 mb-2">
                                        <div class="h-100">

                                            <div class="d-flex justify-content-between d-flex align-items-center" style="color: #161D25;">
                                                    <span style="font-weight: 500;font-size: 16px;">{{$shippingAddress['is_billing']==1?\App\CPU\translate('Default_Billing_Address'):\App\CPU\translate('Default_Shipping_Address')}}</span>
                                                <a href="#billing-section" style="font-weight: 400;font-size: 14px;text-decoration: underline;">Change Address</a>
                                            </div>

                                            <div class="card-body address-card-custom mt-3">
                                                <div><span>{{$shippingAddress['contact_person_name']}}</span>
                                                </div>
                                                <div><span class="font-nameA">{{$shippingAddress['address']}}, {{$shippingAddress['zip']}}</span>
                                                </div>
                                                <div><span class="font-nameA">{{$shippingAddress['city']}}, {{$shippingAddress['country']}}</span>
                                                </div>
                                                <div class="mt-3"><span class="font-nameA"> <strong>{{\App\CPU\translate('Phone')}}  :</strong>  {{$shippingAddress['phone']}}</span>
                                                </div>
                                            </div>
                    ...
                    <div class="card mb-4" id="billing-section">
                        <div class="card-body">
                            <div class="user-profile-head">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <img class="mr-2 position-relative" style="width: 20px; height: 20px; top: -3px;" src="{{asset('assets/front-end/img/location-icon.png')}}"
                                             alt="">
                                        <h3 style=" font-weight: 600;margin-top: 0px;margin-bottom: 7px !important;font-size: 17px;color: #030303;">{{\App\CPU\translate('Billing_Address')}} </h3>
                                    </div>
                                </div>
                            </div>
                            <hr>
                                ...
                                @foreach($shippingAddresses as $shippingAddress)
                                    <section class="col-lg-12">
                                        <div class="h-100">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card-body address-card-custom mt-1">
                                                        <label class="badge text-uppercase" style="background: #77b847; color:white !important; position: relative; border-radius: 10px;">{{$shippingAddress['address_type']}}</label>
                                                        <div><span>{{$shippingAddress['contact_person_name']}}</span>
                                                        </div>
                                                        <div><span class="font-nameA">{{$shippingAddress['address']}}, {{$shippingAddress['zip']}}</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <a class="btn edit-address-btn mr-2 mr-lg-3" title="Edit Address" id="edit" href="{{route('address-edit',$shippingAddress->id)}}">
                                                                Edit
                                                            </a>
                                                            <a class="btn delete-address-btn" title="Delete Address" href="{{ route('address-delete',['id'=>$shippingAddress->id])}}" onclick="return confirm('{{\App\CPU\translate('Are you sure you want to Delete')}}?');" id="delete">
                                                                Delete
                                                            </a>
                                                        </div>
                                                        <a href="#" style="font-weight: 400;font-size: 14px;text-decoration: underline;color: #161D25;">Set As Default</a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="card mb-4" id="shipping-section">
                        <div class="card-body">
                            <div class="user-profile-head">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <img class="mr-2 position-relative" style="width: 20px; height: 20px; top: -3px;" src="{{asset('assets/front-end/img/location-icon.png')}}"
                                             alt="">
                                        <h3 style=" font-weight: 600;margin-top: 0px;margin-bottom: 7px !important;font-size: 17px;color: #030303;">{{\App\CPU\translate('Shipping_Address')}} </h3>
                                    </div>
                                </div>
                            </div>
                            <hr>
