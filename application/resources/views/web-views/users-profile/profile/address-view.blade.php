            ...
            <div class="sidebarR col-lg-3">
                ...
                <div class="price_sidebar rounded-lg box-shadow-sm __mb-n-10" id="shop-sidebar">
                        ...
                        <div class="sidebarL">
                            <h3 class="widget-title btnF font-bold">
                                <a href="{{ route('orderList') }}"
                                   class="__color-1B7FED">{{\App\CPU\translate('My Orders')}}</a>
                            </h3>
                    ...
                    <div class="pb-0 __pt-12">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF font-bold"><a
                                    href=""> {{\App\CPU\translate('Chat With Sellers')}} </a>
                            </h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-0 __pt-12">
                        <!-- Filter by price-->
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF font-bold"><a href="">{{\App\CPU\translate('Address')}} </a>
                            </h3>
                            <div class="divider-role __inline-41"></div>
                    ...
                    <div class="pb-0 __pt-12">
                        ...
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF font-bold"><a
                                    href="">{{\App\CPU\translate('Transaction history')}} </a>
                            </h3>
                            <div class="divider-role __inline-41"></div>
