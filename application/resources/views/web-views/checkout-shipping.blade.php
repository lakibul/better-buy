...
@section('content')
    ...
    <div class="container position-relative pb-5 mb-2 mb-md-4 rtl __inline-56"
         style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}}; padding-bottom: 100px !important;">
        <div class="row">
            ...
            <section class="col-lg-8">
                <div class="--checkout_details">
                    ...
                    @if($physical_product_view)
                        ...
                        <form method="post" class="card __card" id="address-form">
                            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                                <h2 class="h5 mb-0">{{ \App\CPU\translate('choose_shipping_address')}}</h2>
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group">
                                    @foreach($shipping_addresses as $key=>$address)
                                        <li class="checkout-address-list"
                                            onclick="$('#sh-{{$address['id']}}').prop( 'checked', true )">
                                            <input type="radio" name="shipping_method_id"
                                                   id="sh-{{$address['id']}}"
                                                   value="{{$address['id']}}" {{$key==0?'checked':''}}>
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px">
                                            </span>
                                            <label class="badge text-uppercase"
                                                   style="background: {{$web_config['primary_color']}}; color:white !important; position: relative; top: -3px">{{$address['address_type']}}</label>
                                    ...
                                    @endforeach
                                    <li class="checkout-address-list" onclick="anotherAddress()" style="border: none">
                                        <input type="radio" name="shipping_method_id"
                                            ...
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('name')}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="address_type">
                                                            ...
                                                            <option
                                                                value="home">{{ \App\CPU\translate('Home')}}</option>
                                                            <option
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">{{ \App\CPU\translate('City')}}
                                                            <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if($zip_restrict_status == 1)
                                                            <select name="zip" class="form-control selectpicker"
                                                                ...
                                                                @empty
                                                                    <option
                                                                        value="">{{ \App\CPU\translate('No_zip_to_deliver') }}</option>
                                                                @endforelse
                                                            </select>
                                                        @else
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country" id="" class="form-control selectpicker"
                                                            ...
                                                            @empty
                                                                <option
                                                                    value="">{{ \App\CPU\translate('No_country_to_deliver') }}</option>
                                                            @endforelse
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('address')}}
                                                            <span
                                                                class="text-danger">*</span></label>
                    ...
                    <div style="display: {{$billing_input_by_customer?'':'none'}}" class="card my-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5">{{ \App\CPU\translate('choose_billing_address')}}</h2>
                            <button type="button" id="hide_billing_address-btn" class="btn btn-outline"
                        ...
                        @if($physical_product_view)
                            <div class="form-check mb-2 mx-4 py-3"
                                 style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 1.25rem;">
                        ...
                        @endif
                        <form method="post" class="" id="billing-address-form">
                            <div id="hide_billing_address" class="card-body p-0">
                                <ul class="list-group">
                                    @foreach($billing_addresses as $key=>$address)
                                        ...
                                        {{--                                        </li>--}}
                                    @endforeach
                                    <li class="checkout-address-list" style="border: none">
                                        {{--                                        <input type="radio" name="billing_method_id"--}}
                    ...
                    <div class="card">
                        <div class="card-header d-flex">
                            <h2 class="h5">{{ \App\CPU\translate('Payment')}}</h2>
                        </div>
                        <div class="card-body">
                            <form method="post" id="billing_method_select">
                                @csrf
                                <div class="row">
                                    <col-md-6>
                                        <div class="digital-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="CGPAY" checked>
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios1">
                                                <img src="{{asset('assets/front-end/img/cg-pay.png')}}" alt="cg">
                                                <h5 class="mb-0">CGPAY <span class="payment-offer">(30% Cashback)</span></h5>
                                            </label>
                                        </div>
                                        <div class="digital-p-form-check d-flex align-items-center mb-2">
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios2">
                                                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="KHALTI">
                                                <span class="checkmark checkout-checkmark"
                                                      style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>

                                                <img src="{{asset('assets/front-end/img/khalti.png')}}" alt="cg">
                                                <h5 class="mb-0">Khalti</h5>
                                            </label>
                                        </div>
                                        <div class="digital-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="IME PAY">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios3">
                                                <img src="{{asset('assets/front-end/img/imepay.png')}}" alt="cg">
                                                <h5 class="mb-0">IME PAY</h5>
                                            </label>
                                        </div>
                                        <div class="digital-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios4" value="ESEWA">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios4">
                                                <img src="{{asset('assets/front-end/img/esewa.png')}}" alt="cg">
                                                <h5 class="mb-0">eSewa</h5>
                                            </label>
                                        </div>
                                        <div class="digital-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios5" value="IPS">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios5">
                                                <img src="{{asset('assets/front-end/img/ips.png')}}" alt="cg">
                                                <h5 class="mb-0">Connect IPS</h5>
                                            </label>
                                        </div>
                                    </col-md-6>
                                    <col-md-6>
                                        <div class="deferent-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios6" value="COD">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios6">
                                                <img src="{{asset('assets/front-end/img/cash-on.png')}}" alt="cg">
                                                <h5 class="mb-0">Cash On Delivery</h5>
                                            </label>
                                        </div>
                                        <div class="deferent-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios7" value="CARD">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios7">
                                                <img src="{{asset('assets/front-end/img/card-transfer.png')}}" alt="cg">
                                                <h5 class="mb-0">Master/Visa Debit/Credit Card/UnionPay</h5>
                                            </label>
                                        </div>
                                        <div class="deferent-p-form-check d-flex align-items-center mb-2">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios8" value="BANK">
                                            <span class="checkmark checkout-checkmark"
                                                  style="margin-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 10px"></span>
                                            <label class="form-check-label d-flex align-items-center" for="exampleRadios8">
                                                <img src="{{asset('assets/front-end/img/banktransfer.png')}}" alt="cg">
            ...
            @include('web-views.partials._order-summary', ['is_payment_checkout' => 1])
        </div>
        <nav class="navbar checkout-bottom-navbar __rounded-10" id="checkout-bottom-navbar">
            <div class="container py-3">
                <div class="d-flex flex-wrap w-100 justify-content-between">
                    <div style="color: #222F3E;"
                         class="price-section d-flex d-sm-block justify-content-between w-sm-auto">
                        <p class="mb-0" style="font-size: 14px; font-weight: 600;">Total</p>
                        <p class="mb-0" style="font-weight: 400; font-size: 18px;"><span
                                style="font-weight: 700">₹ 3,89,590</span> (VAT incl.)</p>
                    </div>
                    <div class="btn-section d-flex justify-content-sm-end justify-content-between align-items-center">
                        <a href="{{route('shop-cart')}}" class="continue-shopping-btn mr-4">Continue Shopping</a>
                        <a href="javascript:" onclick="proceed_to_next()" class="place-order-btn">Place Order</a>
                    </div>
                </div>
            </div>
        </nav>
...
@push('script')
    ...
    <script>
        function hide_billingAddress() {
            ...
            if (check_same_as_shippping) {
                ...
                $('#hide_billing_address-btn').hide();
            } else {
                $('#hide_billing_address').show();
                $('#hide_billing_address-btn').show();
            }
        }
    </script>
    <script
    ...
    <script>
        function proceed_to_next() {
            ...
            let billing_method = $('#billing_method_select').serializeArray();
            billing_method = billing_method[1]['value'];
            ...
            $.post({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        if (billing_method === 'ESEWA') {
                            location.href = '{{route('checkout-payment',['billing_method'=>'ESEWA'])}}';
                        } else if (billing_method === 'KHALTI') {
                            location.href = '{{route('checkout-payment',['billing_method'=>'KHALTI'])}}';
                        } else if (billing_method === 'COD') {
                            location.href = '{{route('checkout-payment',['billing_method'=>'COD'])}}';
                        }
