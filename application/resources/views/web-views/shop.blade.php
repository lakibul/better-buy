...
@push('css_or_js')
    ...
    <style>
        ...
        @media (max-width: 800px) {
            ...
            {{Session::get('direction') === "rtl" ? 'margin-right: 16px;' : 'margin-left: 0px;'}}
}
        ...
        @media(min-width:801px){
            ...
            .category-product-view-title {
            {{Session::get('direction') === "rtl" ? 'margin-right: 10px;' : 'margin-left: 0px;'}}
}
            .category-product-view-all {
...
@section('content')
    <div class="__inline-61">
        ...
        <section class="bg-transparent mb-3 mt-3">
            <div class="container">
                <div class="row ">
                    <div class="col-12">
        ...
        @if($brand_setting)
            <section class="container rtl mt-3">
                ...
                <div class="section-header">
                    <div class="text-black font-bold __text-22px section-header-title pr-2">
                        <span>{{\App\CPU\translate('Explore')}} {{\App\CPU\translate('Popular')}} {{\App\CPU\translate('brands')}}</span>
                    </div>
                    <div class="__mr-2px ml-2">
                        <a class="text-capitalize view-all-text mt-2" href="{{route('brands')}}">
                            {{ \App\CPU\translate('view_all')}}
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-sm-3 mb-3 brand-slider brand-slider-custom">
                        ...
                        @foreach($brands as $brand)
                            <div class="text-center">
                                <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}" class="__brand-item">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset("application/storage/app/public/brand/$brand->image")}}" alt="{{$brand->name}}">
                                </a>
                            </div>
                        @endforeach
                    </div>
        ...
        <section class="home-shopping-event mt-4 mt-lg-5">
            <div class="container">
            ...
            <section class="container rtl pb-4">
                ...
                <div class="">
                    <div class="flex-wrap __gap-6px d-flex">
                        <div class="category-product-view-title section-header-title pr-2" >
                    ...
                    <div class="d-flex mt-2 justify-content-between g-3">
            ...
            <div class="container mb-2">
                <div class="row">
                    <div class="col-12 pt-5 pb-4">
                        <span class="for-feature-title __text-22px font-bold text-center">Highlights </span>
                    </div>
                    <div class="col-md-12">
                        <div class="carousel-wrap py-1">
                            <div class="owl-carousel owl-theme " id="highlights-banner-first">
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-49.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-50.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-51.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-51.png')}}" alt="{{$brand->name}}">
                                </div>
        ...
        <section class="home-bannder-wrapper">
            <div class="container mb-2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="carousel-wrap py-1">
                            <div class="owl-carousel owl-theme " id="highlights-banner-sec">
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-52.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-53.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-48.png')}}" alt="{{$brand->name}}">
                                </div>
                                <div class="w-100">
                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('assets/front-end/img/image-51.png')}}" alt="{{$brand->name}}">
                                </div>
