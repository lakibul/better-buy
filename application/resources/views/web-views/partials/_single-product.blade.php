...
<div class="product-single-hover">
    ...
    <div class="d-flex justify-content-end position-relative">
        ...
        <div class="wishlist-btn">
            <button onclick="addWishlist('{{$product['id']}}')"><i class="fa fa-heart-o" aria-hidden="true"
                                                                   style="color: #656565"></i></button>
        </div>
    </div>
                ...
                font-size: 10px;">
                                @for($inc=0;$inc<5;$inc++)
                                    @if($inc<$overallRating[0])
                                        <i class="sr-star czi-star-filled active" style="color:{{$web_config['primary_color']}} !important"></i>
                                    @else
                    ...
                    <div class="col-6 text-center card-loyality">
