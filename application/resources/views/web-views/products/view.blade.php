    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl __inline-35"
        ...
        <div class="row">
            ...
            <aside
                ...
                id="SearchParameters">
                <!--Price Sidebar-->
                <div class="cz-sidebar box-shadow-lg __inline-35 p-3" id="shop-sidebar">
                    ...
                    <div class="pb-0" >
                        <!-- Filter by price-->
                        <div class="">
                            <div class="__cate-side-title border-bottom d-none">
                                <span class="widget-title font-semibold">{{\App\CPU\translate('filter')}} </span>
                            </div>
                            <div
                                class=" w-100 pt-4">
                                <label for="searchByFilterValue" class="filterselect-label">{{\App\CPU\translate('Sort_By')}} </label>
                                <label class="w-100 text-nowrap for-shoting d-block mb-0" for="sorting" style="padding-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 0">
                    ...
                    <div class="mt-3" >
                        ...
                        <div class="--text-center">
                            <div class="__cate-side-title border-top border-bottom d-none">
                                <span class="widget-title font-semibold">{{\App\CPU\translate('Price')}} </span>
                            </div>
                            <label for="searchByFilterValue" class="filterselect-label">{{\App\CPU\translate('Price')}} </label>
                            <div class="d-flex justify-content-between">
                                <p id="slider-snap-value-lower"></p>
                                <p id="slider-snap-value-upper"></p>
                            </div>
                            <div class="slider-handles" id="slider-handles"></div>
                            <div class="--d-flex d-none justify-content-between align-items-center __cate-side-price">
                                <div class="__w-35p">
            ...
            <section class="col-lg-9">
                    <img class="w-100" src="{{asset('assets/front-end/img/category-banner.png')}}">
...
{{--                </div>--}}
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="categories-page-title pt-3 pb-1 ml-1">{{ isset($brand_name) ? $brand_name : ''}}</h1>
                    <div>
