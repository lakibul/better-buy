...
namespace Illuminate\Support\Facades {
    ...
    class DB
    {
        ...
        {            //Method inherited from \Illuminate\Database\MySqlConnection
            /** @var \Hoyvoy\CrossDatabase\MySqlConnection $instance */
         ...
         *
         * @param \Closure $callback
         * @return \Hoyvoy\CrossDatabase\MySqlConnection
         * @static
         */
        ...
        {            //Method inherited from \Illuminate\Database\Connection
            \Hoyvoy\CrossDatabase\MySqlConnection::resolverFor($driver, $callback);
        }
        ...
        {            //Method inherited from \Illuminate\Database\Connection
            return \Hoyvoy\CrossDatabase\MySqlConnection::getResolver($driver);
        }
...
namespace Seshac\Shiprocket {
    ...
    class Shiprocket
    {
         ...
         * @static
         */
        public static function login($credentials = null)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
         ...
         * @static
         */
        public static function getToken($credentials = null)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->getToken($credentials);
        }
         ...
         * @static
         */
        public static function order($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->order($token);
        }
         ...
         * @static
         */
        public static function pickup($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->pickup($token);
        }
         ...
         * @static
         */
        public static function courier($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->courier($token);
        }
         ...
         * @static
         */
        public static function shipment($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->shipment($token);
        }
        ...
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->generate($token);
        }
         ...
         * @static
         */
        public static function product($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->product($token);
        }
         ...
         * @static
         */
        public static function warehouse($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->warehouse($token);
        }
         ...
         * @static
         */
        public static function ndr($token)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->ndr($token);
        }
         ...
         * @static
         */
        public static function auth($client, $credentials = null)
        {
            /** @var \Seshac\Shiprocket\ShiprocketApi $instance */
            return $instance->auth($client, $credentials);
        }
...
namespace {
    ...
    class Helper extends \App\CPU\Helpers
    {
    }
    ...
    class Shiprocket extends \Seshac\Shiprocket\Shiprocket
    {
    }
