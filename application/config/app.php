...
use App\Providers\PaymentConfigProvider;
...
return [
    ...
    */
    ...
    'core_url' => env('CORE_BASE_URL', 'http://127.0.0.1/cg-walltetcore-backend'),
    'super_url' => env('SUPER_BASE_URL', 'http://127.0.0.1/cg-super-backend'),
