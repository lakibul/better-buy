...
class ProductManager
{
    ...
    public static function get_latest_products($limit = 10, $offset = 1): array
    {
    ...
    public static function get_featured_products($limit = 10, $offset = 1): array
    {
    ...
    public static function get_top_rated_products($limit = 10, $offset = 1): array
    {
    ...
    public static function get_best_selling_products($limit = 10, $offset = 1): array
    {
    ...
    public static function search_products($name, $limit = 10, $offset = 1): array
    {
        /*$key = explode(' ', $name);*/
    ...
    public static function search_products_web($name, $limit = 10, $offset = 1): array
    {
        /*$key = explode(' ', $name);*/
        $key = explode(' ', $name);
    ...
    public static function translated_product_search($name, $limit = 10, $offset = 1): array
    {
    ...
    public static function translated_product_search_web($name, $limit = 10, $offset = 1): array
    {
        $key = explode(' ', $name);
        $product_ids = Translation::where('translationable_type', 'App\Model\Product')
            ->where('key', 'name')
    ...
    public static function product_image_path($image_type): string
    {
        $path = '';
        if ($image_type == 'thumbnail') {
            $path = asset('application/storage/app/public/product/thumbnail');
        } elseif ($image_type == 'product') {
            $path = asset('application/storage/app/public/product');
        }
        return $path;
    }
    ...
    public static function get_rating($reviews): array
    {
        $rating5 = 0;
        $rating4 = 0;
        $rating3 = 0;
    ...
    public static function get_seller_products($seller_id, $limit = 10, $offset = 1): array
    {
    ...
    public static function get_seller_all_products($seller_id, $limit = 10, $offset = 1): array
    {
    ...
    public static function get_discounted_product($limit = 10, $offset = 1): array
    {
        //change review to ratting
    ...
    public static function export_product_reviews($data): array
    {
        $storage = [];
