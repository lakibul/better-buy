...
class Helpers
{
    ...
    public static function rating_count($product_id, $rating): int
    {
    ...
    public static function get_business_settings($name)
    {
        ...
        $config = null;
        $check = ['currency_model', 'currency_symbol_position', 'system_default_currency', 'language', 'company_name', 'decimal_point_settings', 'recaptcha'];
    ...
    public static function get_seller_by_token($request): array
    {
        $data = '';
        $success = 0;
...
//            dd($str);
    ...
    public static function otp_generator(): int
    {
