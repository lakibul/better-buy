...
//            ->orderBy('orders_count', 'DESC')
        ...
        return view('web-views.home',
            compact('featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories')
        );
    }
...
//            ->orderBy('orders_count', 'DESC')
    ...
    public function checkout_payment(Request $request)
    {
        ...
        if (session()->has('address_id') && count($cart_group_ids) > 0) {
            return view('web-views.checkout-payment', compact('cod_not_show', 'billing_method'));
        }
