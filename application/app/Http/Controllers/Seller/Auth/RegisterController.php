...
class RegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $seller = Seller::whereEmail($request->email)->first();
        if ($seller) {
            Toastr::warning('The Email is already taken!');
            return back();
        }

        $seller = Seller::wherePhone($request->phone)->first();
        if ($seller) {
            Toastr::warning('The Phone is already taken!');
            return back();
        }
