...
class OrderController extends Controller
{
    ...
    public function digital_file_upload_after_sell(Request $request)
    {
        ...
        if($order_details->save()){
            //log
            Log_module::sellerProductDigitalFile();
            Toastr::success('Digital file upload successfully!');
        }else{
            //log
            Log_module::sellerProductDigitalFileFailed();
    ...
    public function add_delivery_man($order_id, $delivery_man_id)
    {
        ...
        //log
        Log_module::sellerDeliveryManAdded();
    ...
    public function payment_status(Request $request)
    {
        if ($request->ajax()) {
            ...
            $order->save();
            //log
            Log_module::sellerOrderPaymentStatus();
    ...
    public function status(Request $request)
    {
        ...
        //log
        Log_module::sellerOrderStatus($order);
        ...
        if ($order->delivery_man_id && $request->order_status == 'delivered') {
            ...
            if($order->deliveryman_charge && $request->order_status == 'delivered'){
                ...
                //log
                Log_module::sellerDeliveryManTransaction();
            }
        }
    ...
    public function amount_date_update(Request $request){
        ...
        try {
            ...
            $order->save();
            //log
            Log_module::sellerOrderAmountDate();
    ...
    public function update_deliver_info(Request $request)
    {
        ...
        $order->save();
        //log
        Log_module::seller_driver_info_update();
